        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-16 p-6 sm:p-8 bg-card border border-border rounded-2xl">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Создать самый полный, удобный и красивый цифровой архив жизни и творчества 
              Димы Масленникова в одном месте. Мы хотим, чтобы каждый фанат мог легко найти 
              любое видео, узнать интересные факты и погрузиться в историю одного из самых 
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                "Интерактивная хронология (2014–2026)",
                "Полный каталог видео с фильтрами",
