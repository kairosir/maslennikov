      ...
      <main className="min-h-screen pt-20 pb-16">
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-16 prose prose-invert max-w-none">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Поворотным моментом в карьере стал 2019 год и запуск серии Abandoned — 
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Серия Abandoned стала визитной карточкой канала. Заброшенные больницы, 
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              ...
              Abandoned, экспериментировать с новыми форматами и работать над музыкальными 
              проектами.
            </p>
          </section>
