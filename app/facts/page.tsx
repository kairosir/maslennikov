...
const facts = [
  {
    ...
    items: [
      ...
      "Коллекционирует артефакты, найденные во время съёмок Abandoned.",
    ],
  },
  {
    category: "Карьера",
    items: [
      ...
      "Серия Abandoned началась как эксперимент и стала главным форматом канала.",
      "Снял более 100 выпусков Abandoned в разных странах мира.",
  ...
  },
  {
    ...
    items: [
      ...
      "Суммарное количество просмотров превышает 2 миллиарда.",
      "Один из первых русскоязычных блогеров, достигших 10 миллионов подписчиков.",
    ],
  },
  {
    category: "Интересное",
    items: [
      "Многие локации для Abandoned находит сам, изучая старые карты и форумы.",
